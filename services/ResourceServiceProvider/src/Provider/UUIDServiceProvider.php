...
class UuidServiceProvider implements ServiceProviderInterface
{
  ...
  */
  function register(Application $app) {
    ...
    $app['islandora.baseuuid5'] = $app->share(function() use ($app) {
    ...
    $app['islandora.uuid5'] = $app->protect(function($word, $namespace = NULL) use ($app) {
      if (!isset($namespace)) {
    ...
    $app['islandora.uuid4'] = $app->protect(function() use ($app) {
      $uuid4 = Uuid::uuid4();
