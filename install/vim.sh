...
# Copy over the vimrc
cp /home/vagrant/islandora/install/.vimrc /home/vagrant/.vimrc
...
DISPLAY=:1 /home/vagrant/eclipse/eclipse -nosplash -consolelog -debug \
...
chown -R vagrant:vagrant /home/vagrant/eclim
chown -R vagrant:vagrant /home/vagrant/.vim

# Build and install from source (run as the vagrant user)
cd eclim
sudo -u vagrant ant -Declipse.home=/home/vagrant/eclipse -Dvim.files=/home/vagrant/.vim

# Start Eclim (run as the vagrant user)
sudo -u vagrant DISPLAY=:1 /home/vagrant/eclipse/eclimd -b
